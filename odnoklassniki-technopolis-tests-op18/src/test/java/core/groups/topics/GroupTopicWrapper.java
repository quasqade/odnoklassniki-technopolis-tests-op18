...
public class GroupTopicWrapper {
  ...
  private static final By FORBID_COMMENTS = By
      .xpath("//*[contains(@href, 'CloseTopicForComments')]");
  private static final By COMMENT_WIDGET = By
      .xpath("//*[contains(@data-location, 'CommentWidget')]/parent::*");
