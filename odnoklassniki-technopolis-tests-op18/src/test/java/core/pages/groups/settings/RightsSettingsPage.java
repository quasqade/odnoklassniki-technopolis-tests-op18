...
public class RightsSettingsPage extends AbstractSettingsPage {
  ...
  private static final By NOTIFICATION_FREQUENCY_DROPDOWN = By.xpath("//*[contains(@id, 'joinRequestNotification')]");
  ...
  public void selectJoinNotificationFrequency(String frequency){
    if (!explicitWait(ExpectedConditions.visibilityOfElementLocated(NOTIFICATION_FREQUENCY_DROPDOWN), 5, 500))
